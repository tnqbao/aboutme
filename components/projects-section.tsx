          ...
          >
            ...
            <CardHeader className="relative z-10">
              ...
              <CardDescription className="text-gray-400 text-base">
                A cutting-edge project offering free access to comics and movies using a microservices architecture.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6 relative z-10">
              <p className="text-gray-300">
                Independent containers communicate via HTTPS and gRPC APIs, ensuring robust and scalable operations. The
                platform features a modular design for easy integration, delivering a high-performance and user-friendly
