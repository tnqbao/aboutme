    ...
    <Tabs defaultValue="gauphim" className="mt-6">
      ...
      <TabsContent value="gauphim" className="space-y-4 mt-4">
        <div className="rounded-lg border border-gray-700 p-4 bg-gray-800/30">
          <div className="aspect-video w-full overflow-hidden rounded-md mb-4 bg-gray-950">
            <img
              src="https://i.imgur.com/nF71Sj1.png"
              alt="Gau Phim Screenshot"
      ...
      <TabsContent value="gautruyen" className="space-y-4 mt-4">
        <div className="rounded-lg border border-gray-700 p-4 bg-gray-800/30">
          <div className="aspect-video w-full overflow-hidden rounded-md mb-4 bg-gray-950">
            <img
              src="https://i.imgur.com/crVI7O8.png?height=400&width=800"
              alt="Gau Truyen Screenshot"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            <div className="bg-gray-900/50 p-3 rounded-md">
              <div className="text-xs text-gray-400">Total Metrics</div>
              <div className="text-xl font-bold text-white">6,500+</div>
            </div>
            <div className="bg-gray-900/50 p-3 rounded-md">
